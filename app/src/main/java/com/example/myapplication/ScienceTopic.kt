...
class ScienceTopic : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_science_topic)

        // Get the list of TitleDescription objects from the repository
        dataClassTitleDescriptions = ScienceTitleDescriptionRepository.getTitleDescriptions()
