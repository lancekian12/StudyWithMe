...
class EnglishTopicQuiz : AppCompatActivity() {
    ...
    private val questionList: ArrayList<DataClassQuestionAnswer> = EnglishQuestionRepository.getQuestion()
    private var currentQuestionIndex: Int = 0

    @SuppressLint("MissingInflatedId", "SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_english_topic_quiz)
        ...
        countdownTimer = object : CountDownTimer(initialTimeMillis.toLong(), 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@EnglishTopicQuiz, TryAgain::class.java)
