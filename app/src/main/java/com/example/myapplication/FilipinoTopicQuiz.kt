...
class FilipinoTopicQuiz : AppCompatActivity() {
    ...
    // Variables to store the original drawable resources for ivA, ivB, ivC, and ivD
    ...
    private val questionList: ArrayList<DataClassQuestionAnswer> = FilipinoQuestionRepository.getQuestion()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        countdownTimer = object : CountDownTimer(initialTimeMillis.toLong(), 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@FilipinoTopicQuiz, TryAgain::class.java)
                    ...
                    if(total == 0 ) {
                        if (currentQuestionIndex < 4) {
                            ...
                            if (numberOfCorrects >= 4) {
                                val intent = Intent(this, ActivityResultFilipino::class.java)
