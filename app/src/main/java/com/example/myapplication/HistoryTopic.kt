...
class HistoryTopic : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataClassTitleDescriptions = HistoryTitleDescriptionRepository.getTitleDescriptions()
