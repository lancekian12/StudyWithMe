...
class MathTopicQuiz : AppCompatActivity() {
    ...
    private val questionList: ArrayList<DataClassQuestionAnswer> = MathQuestionRepository.getQuestion()
    private var currentQuestionIndex: Int = 0

    @SuppressLint("MissingInflatedId", "SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_math_quiz_topic)
        ...
        countdownTimer = object : CountDownTimer(initialTimeMillis.toLong(), 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@MathTopicQuiz, TryAgain::class.java)
                    ...
                    if(total == 0 ) {
                        if (currentQuestionIndex < 4) {
                            ...
                            if (numberOfCorrects >= 4) {
                                val intent = Intent(this, ActivityResultMath::class.java)
