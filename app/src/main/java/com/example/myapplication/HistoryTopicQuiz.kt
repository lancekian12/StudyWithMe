...
class HistoryTopicQuiz : AppCompatActivity() {
    ...
    private val questionList: ArrayList<DataClassQuestionAnswer> = HistoryQuestionRepository.getQuestion()
    private var currentQuestionIndex: Int = 0

    @SuppressLint("MissingInflatedId", "SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_history_topic_quiz)
        ...
        countdownTimer = object : CountDownTimer(initialTimeMillis.toLong(), 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@HistoryTopicQuiz, TryAgain::class.java)
        ...
        backButton.setOnClickListener {
            val intent = Intent(this, HistoryContent::class.java)
            startActivity(intent)
        }
        ...
        if(total ==0 ) {
            ...
            topic.text = "History: American Colonial Period"
            loadQuestion(startingPosition3)
        }
        else if(total >= 7){
            topic.text = "History: Edsa Revolution"
            loadQuestion(startingPosition2)
        }
        else if(total >= 3){
            topic.text = "History: Ancient Civilization"
                    ...
                    if(total == 0 ) {
                        if (currentQuestionIndex < 4) {
                            ...
                            if (numberOfCorrects >= 4) {
                                val intent = Intent(this, ActivityResultHistory::class.java)
