...
class EnglishTopic : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_english_topic)

        // Get the list of TitleDescription objects from the repository
        dataClassTitleDescriptions = EnglishTitleDescriptionRepository.getTitleDescriptions()
        ...
        backButton.setOnClickListener {
            val intent = Intent(this,EnglishContent::class.java)
        ...
        if (total == 0) {
            ...
            topic.text = "English: Folktale"
            theTitle.text = "TYPES OF FOLKTALE"
            displayTitleDescription(startingPosition3)
        } else if (getTotal >= 7) {
            topic.text = "English: Literature"
            theTitle.text = "TYPES OF LITERATURE"
            displayTitleDescription(startingPosition2)
        } else if (getTotal >= 3) {
            topic.text = "English: Figure of Speech"
            theTitle.text = "TYPES OF FIGURE OF SPEECH"
